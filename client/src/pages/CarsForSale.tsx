  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" fill="currentColor" className="w-full h-full">
        <path fillRule="evenodd" clipRule="evenodd" d="M50,4C24.6,4,4,24.6,4,50s20.6,46,46,46s46-20.6,46-46S75.4,4,50,4z M50,13c20.4,0,37,16.6,37,37S70.4,87,50,87S13,70.4,13,50S29.6,13,50,13z M50,23c-14.9,0-27,12.1-27,27s12.1,27,27,27s27-12.1,27-27S64.9,23,50,23z M50,32c-9.9,0-18,8.1-18,18s8.1,18,18,18s18-8.1,18-18S59.9,32,50,32z M50,41c-5,0-9,4-9,9s4,9,9,9s9-4,9-9S55,41,50,41z M44,13.7V31h12V13.7C53.4,13.2,51.7,13,50,13C48.3,13,46.6,13.2,44,13.7z M44,69v17.3C46.6,86.8,48.3,87,50,87c1.7,0,3.4-0.2,6-0.7V69H44z M13.7,44H31v12H13.7C13.2,53.4,13,51.7,13,50C13,48.3,13.2,46.6,13.7,44z M69,44h17.3C86.8,46.6,87,48.3,87,50c0,1.7-0.2,3.4-0.7,6H69V44z M21.2,22.6L32.6,34l8.5-8.5L29.7,14.1C26.6,16.4,23.7,19.3,21.2,22.6z M59,66l11.3,11.4c3.1-2.3,6-5.2,8.5-8.5L67.4,57.5L59,66z M70.3,14.1L59,25.5l8.5,8.5l11.3-11.4C76.3,19.3,73.4,16.4,70.3,14.1z M41,57.5L29.7,68.9c3.1,3.3,6,6.2,9.1,8.5L50,66L41,57.5z"/>
      </svg>
    ),
  },
];
