...
const BODY_TYPES_QUICK = [
  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 122.88 54" fill="currentColor" className="w-full h-full">
        <path fillRule="evenodd" clipRule="evenodd" d="M22.5,38c5.52,0,10,4.48,10,10s-4.48,10-10,10s-10-4.48-10-10S16.98,38,22.5,38z M22.5,43c2.76,0,5,2.24,5,5s-2.24,5-5,5s-5-2.24-5-5S19.74,43,22.5,43z M97,38c5.52,0,10,4.48,10,10s-4.48,10-10,10s-10-4.48-10-10S91.48,38,97,38z M97,43c2.76,0,5,2.24,5,5s-2.24,5-5,5s-5-2.24-5-5S94.24,43,97,43z M21.5,29v3.5h3.5C24.61,30.8,23.2,29.39,21.5,29z M25,34.5h-3.5V38C23.2,37.61,24.61,36.2,25,34.5z M19,38v-3.5h-3.5C15.89,36.2,17.3,37.61,19,38z M15.5,32.5H19V29C17.3,29.39,15.89,30.8,15.5,32.5z M95.5,29v3.5H99C98.61,30.8,97.2,29.39,95.5,29z M99,34.5h-3.5V38C97.2,37.61,98.61,36.2,99,34.5z M93,38v-3.5h-3.5C89.89,36.2,91.3,37.61,93,38z M89.5,32.5H93V29C91.3,29.39,89.89,30.8,89.5,32.5z M3.5,36.5C1.57,36.5,0,34.93,0,33V20c0-1.93,1.57-3.5,3.5-3.5H8c0-1,0.1-2.5,1.5-4C14,7.5,22,4,32,2.5C40,1.3,52,0.5,64,0.5h12c9,0,16,1,22,4c3,1.5,5.5,4,6.5,7l4,12c3,1,4,2.5,4,5.5V33c0,2-1.5,3.5-3.5,3.5H107c0-5.52-4.48-10-10-10s-10,4.48-10,10H32.5c0-5.52-4.48-10-10-10s-10,4.48-10,10H3.5z M12,16.5h26V5C30,5.5,22,7,15,11C13,12,12,14,12,16.5z M42,16.5h34V3.5C68,3.5,58,4,50,5L42,16.5z M80,16.5h28c-1-3-3-5-6-6.5c-5-2.5-10-3.5-17-4L80,16.5z"/>
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 122.88 54" fill="currentColor" className="w-full h-full">
        <path fillRule="evenodd" clipRule="evenodd" d="M18,38c5.52,0,10,4.48,10,10s-4.48,10-10,10s-10-4.48-10-10S12.48,38,18,38z M18,43c2.76,0,5,2.24,5,5s-2.24,5-5,5s-5-2.24-5-5S15.24,43,18,43z M98,38c5.52,0,10,4.48,10,10s-4.48,10-10,10s-10-4.48-10-10S92.48,38,98,38z M98,43c2.76,0,5,2.24,5,5s-2.24,5-5,5s-5-2.24-5-5S95.24,43,98,43z M112,38c5.52,0,10,4.48,10,10s-4.48,10-10,10s-10-4.48-10-10S106.48,38,112,38z M112,43c2.76,0,5,2.24,5,5s-2.24,5-5,5s-5-2.24-5-5S109.24,43,112,43z M16,29v3.5h3.5C19.11,30.8,17.7,29.39,16,29z M19.5,34.5H16V38C17.7,37.61,19.11,36.2,19.5,34.5z M13.5,38v-3.5H10C10.39,36.2,11.8,37.61,13.5,38z M10,32.5h3.5V29C11.8,29.39,10.39,30.8,10,32.5z M96.5,29v3.5H100C99.61,30.8,98.2,29.39,96.5,29z M100,34.5h-3.5V38C98.2,37.61,99.61,36.2,100,34.5z M94,38v-3.5h-3.5C90.89,36.2,92.3,37.61,94,38z M90.5,32.5H94V29C92.3,29.39,90.89,30.8,90.5,32.5z M110.5,29v3.5H114C113.61,30.8,112.2,29.39,110.5,29z M114,34.5h-3.5V38C112.2,37.61,113.61,36.2,114,34.5z M108,38v-3.5h-3.5C104.89,36.2,106.3,37.61,108,38z M104.5,32.5H108V29C106.3,29.39,104.89,30.8,104.5,32.5z M0,33V8c0-2.21,1.79-4,4-4h38c2.21,0,4,1.79,4,4v6h66c3,0,6,2,8,5l4,10c2,1,2,2,2,4v5c0,2-1,3-3,3H120c0-5.52-4.48-10-10-10c-1.15,0-2.26,0.2-3.3,0.56C105.27,28.2,101.8,26,98,26c-3.8,0-7.27,2.2-8.7,5.56C88.26,31.2,87.15,31,86,31H28c0-5.52-4.48-10-10-10s-10,4.48-10,10H3C1.34,31,0,30,0,33z M8,26.5C8,22.91,10.91,20,14.5,20H25V8H4v22.12C5.1,27.98,6.46,27,8,26.5z M44,26h38V14H44V26z M86,26h20l-3-8c-1-2-3-4-5-4H86V26z M29,8v18h11V8H29z"/>
      </svg>
    ),
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 122.88 54" fill="currentColor" className="w-full h-full">
        <path fillRule="evenodd" clipRule="evenodd" d="M22.5,38c5.52,0,10,4.48,10,10s-4.48,10-10,10S12.5,53.52,12.5,48S16.98,38,22.5,38z M22.5,43c2.76,0,5,2.24,5,5s-2.24,5-5,5s-5-2.24-5-5S19.74,43,22.5,43z M97,38c5.52,0,10,4.48,10,10s-4.48,10-10,10S87,53.52,87,48S91.48,38,97,38z M97,43c2.76,0,5,2.24,5,5s-2.24,5-5,5s-5-2.24-5-5S94.24,43,97,43z M21,29v3.5h3.5C24.11,30.8,22.7,29.39,21,29z M24.5,34.5H21V38C22.7,37.61,24.11,36.2,24.5,34.5z M18.5,38v-3.5H15C15.39,36.2,16.8,37.61,18.5,38z M15,32.5h3.5V29C16.8,29.39,15.39,30.8,15,32.5z M95.5,29v3.5H99C98.61,30.8,97.2,29.39,95.5,29z M99,34.5h-3.5V38C97.2,37.61,98.61,36.2,99,34.5z M93,38v-3.5h-3.5C89.89,36.2,91.3,37.61,93,38z M89.5,32.5H93V29C91.3,29.39,89.89,30.8,89.5,32.5z M4,14.5C1.79,14.5,0,16.29,0,18.5V33c0,2.21,1.79,4,4,4h8.5c0-5.52,4.48-10,10-10s10,4.48,10,10h54c0-5.52,4.48-10,10-10s10,4.48,10,10h8.5c2.21,0,4-1.79,4-4V18.5c0-2.21-1.79-4-4-4H4z M12,20h98v10H12V20z"/>
      </svg>
    ),
  },
];
