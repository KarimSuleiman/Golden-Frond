  ...
  },
  {
    ...
    svg: (
      <svg viewBox="0 0 100 100" fill="currentColor" className="w-full h-full">
        <path fillRule="evenodd" clipRule="evenodd" d="M50,5C25.15,5,5,25.15,5,50s20.15,45,45,45s45-20.15,45-45S74.85,5,50,5z M50,14c19.88,0,36,16.12,36,36s-16.12,36-36,36S14,69.88,14,50S30.12,14,50,14z M50,22c-15.46,0-28,12.54-28,28s12.54,28,28,28s28-12.54,28-28S65.46,22,50,22z M50,30c11.05,0,20,8.95,20,20s-8.95,20-20,20s-20-8.95-20-20S38.95,30,50,30z M50,42c-4.42,0-8,3.58-8,8s3.58,8,8,8s8-3.58,8-8S54.42,42,50,42z M47,14.2V29h6V14.2C51,14.07,50.5,14,50,14S49,14.07,47,14.2z M47,71v14.8c2,0.13,2.5,0.2,3,0.2s1-0.07,3-0.2V71H47z M14.2,47H29v6H14.2C14.07,51,14,50.5,14,50S14.07,49,14.2,47z M71,47h14.8C85.93,49,86,49.5,86,50s-0.07,1-0.2,3H71V47z M24.93,20.1l10.61,10.61l-4.24,4.24L20.69,24.34C22.03,22.83,23.43,21.42,24.93,20.1z M68.7,64.94l10.37,10.37c-1.41,1.5-2.88,2.91-4.41,4.24L64.47,69.37L68.7,64.94z M75.07,20.1c1.5,1.32,2.9,2.73,4.24,4.24L68.7,35.05l-4.24-4.24L75.07,20.1z M35.54,64.94l4.24,4.24L29.31,79.55c-1.53-1.33-3-2.74-4.38-4.24L35.54,64.94z"/>
      </svg>
    ),
  },
];
