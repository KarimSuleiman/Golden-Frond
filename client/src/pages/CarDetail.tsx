        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          >
            <div>
              ...
              <p className="text-lg text-muted-foreground">موديل {car.year}</p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex items-center gap-3 p-4 rounded-xl bg-card border border-border">
                ...
                <div className="flex flex-col">
                  <span className="text-xs uppercase text-muted-foreground tracking-wider">اللون</span>
              ...
              <div className="flex items-center gap-3 p-4 rounded-xl bg-card border border-border">
                ...
                <div className="flex flex-col">
                  <span className="text-xs uppercase text-muted-foreground tracking-wider">رقم الشاصي</span>
              ...
              {car.price && (
                <div className="flex items-center gap-3 p-4 rounded-xl bg-card border border-border">
                  ...
                  <div className="flex flex-col">
                    <span className="text-xs uppercase text-muted-foreground tracking-wider">السعر</span>
              ...
              <div className="flex items-center gap-3 p-4 rounded-xl bg-card border border-border">
                ...
                <div className="flex flex-col">
                  <span className="text-xs uppercase text-muted-foreground tracking-wider">تاريخ الإضافة</span>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {car.containerNumber && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                      ...
                      <div>
                        <span className="text-xs text-muted-foreground block">رقم الكونتينر</span>
                  ...
                  {car.bookingNumber && (
                    <div className="flex items-center gap-3 p-3 bg-white rounded-lg">
                      ...
                      <div>
                        <span className="text-xs text-muted-foreground block">رقم الحجز</span>
