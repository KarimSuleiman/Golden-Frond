...
const translations: Translations = {
  ...
  "nav.incomingCars": { ar: "سيارات قيد التحميل", en: "Cars in Transit" },
  "incoming.title": { ar: "سيارات قيد التحميل", en: "Cars in Transit" },
  "incoming.subtitle": { ar: "سيارات قادمة من المزادات • شاهد ما سيصل قريباً", en: "Cars arriving from auctions • See what's coming soon" },
  "incoming.addCar": { ar: "إضافة سيارة", en: "Add Car" },
  "incoming.noCars": { ar: "لا توجد سيارات قيد التحميل حالياً", en: "No cars in transit currently" },
  "incoming.status.coming": { ar: "قيد الشحن", en: "In Transit" },
  "incoming.status.arrived": { ar: "وصلت", en: "Arrived" },
  "incoming.estimatedArrival": { ar: "الوصول المتوقع", en: "Expected Arrival" },
  "incoming.details": { ar: "التفاصيل", en: "Details" },
  "incoming.form.title": { ar: "إضافة سيارة قادمة", en: "Add Incoming Car" },
  "incoming.form.status": { ar: "حالة الشحن", en: "Shipping Status" },
  "incoming.delete.title": { ar: "حذف السيارة", en: "Delete Car" },
  "incoming.delete.desc": { ar: "هل أنت متأكد من حذف هذه السيارة؟ لا يمكن التراجع.", en: "Are you sure you want to delete this car? This cannot be undone." },
  ...
  "marketplace.sort": { ar: "ترتيب", en: "Sort" },
  "marketplace.sortNewest": { ar: "الأحدث أولاً", en: "Newest First" },
  "marketplace.sortOldest": { ar: "الأقدم أولاً", en: "Oldest First" },
  "marketplace.sortPriceLow": { ar: "السعر: من الأقل", en: "Price: Low to High" },
  "marketplace.sortPriceHigh": { ar: "السعر: من الأعلى", en: "Price: High to Low" },
  "marketplace.sortYearNew": { ar: "سنة الصنع: الأحدث", en: "Year: Newest" },
  "marketplace.sortYearOld": { ar: "سنة الصنع: الأقدم", en: "Year: Oldest" },
  "marketplace.sortMileageLow": { ar: "الكيلومترات: الأقل", en: "Mileage: Low to High" },
  "marketplace.sortMileageHigh": { ar: "الكيلومترات: الأعلى", en: "Mileage: High to Low" },
  ...
  // Filter Panel
  "filter.title": { ar: "فلترة", en: "Filter" },
  "filter.clearAll": { ar: "حذف الخيارات", en: "Clear Options" },
  "filter.apply": { ar: "فلترة", en: "Apply Filter" },
  "filter.all": { ar: "الكل", en: "All" },
  "filter.condition": { ar: "الحالة", en: "Condition" },
  "filter.make": { ar: "النوع", en: "Make" },
  "filter.model": { ar: "موديل", en: "Model" },
  "filter.category": { ar: "الفئة", en: "Category" },
  "filter.yearRange": { ar: "سنة الصنع", en: "Year" },
  "filter.minYear": { ar: "أدنى سنة", en: "Min Year" },
  "filter.maxYear": { ar: "أعلى سنة", en: "Max Year" },
  "filter.olderThan1970": { ar: "أقدم من 1970", en: "Older than 1970" },
  "filter.price": { ar: "السعر", en: "Price" },
  "filter.minPrice": { ar: "أدنى سعر", en: "Min Price" },
  "filter.maxPrice": { ar: "أعلى سعر", en: "Max Price" },
  "filter.dinar": { ar: "دينار", en: "JOD" },
  "filter.mileage": { ar: "الكيلومترات", en: "Mileage" },
  "filter.bodyType": { ar: "نوع الهيكل", en: "Body Type" },
  "filter.bodySUV": { ar: "اس يو في", en: "SUV" },
  "filter.bodyVan": { ar: "باص / فان", en: "Bus / Van" },
  "filter.bodyPickup": { ar: "بيك اب", en: "Pickup" },
  "filter.bodyTruck": { ar: "شاحنة", en: "Truck" },
  "filter.bodySedan": { ar: "صالون / سيدان", en: "Sedan" },
  "filter.bodyConvertible": { ar: "كشف", en: "Convertible" },
  "filter.bodyCoupe": { ar: "كوبيه", en: "Coupe" },
  "filter.bodyHatchback": { ar: "هاتشباك", en: "Hatchback" },
  "filter.seats": { ar: "عدد المقاعد", en: "Seats" },
  "filter.moreThan9": { ar: "أكثر من 9", en: "More than 9" },
  "filter.fuelType": { ar: "نوع الوقود", en: "Fuel Type" },
  "filter.fuelPetrol": { ar: "بنزين", en: "Petrol" },
  "filter.fuelDiesel": { ar: "ديزل", en: "Diesel" },
  "filter.fuelElectric": { ar: "كهربائي", en: "Electric" },
  "filter.fuelMildHybrid": { ar: "مايلد هايبرد", en: "Mild Hybrid" },
  "filter.fuelHybrid": { ar: "هايبرد", en: "Hybrid" },
  "filter.fuelPluginHybrid": { ar: "هايبرد - Plug-in", en: "Plug-in Hybrid" },
  "filter.transmission": { ar: "نوع ناقل الحركة", en: "Transmission" },
  "filter.automatic": { ar: "اوتوماتيك", en: "Automatic" },
  "filter.manual": { ar: "يدوي/عادي", en: "Manual" },
  "filter.exteriorColor": { ar: "اللون الخارجي", en: "Exterior Color" },
  "filter.interiorColor": { ar: "اللون الداخلي", en: "Interior Color" },
  "filter.moreColors": { ar: "المزيد من الألوان", en: "More Colors" },
  "filter.lessColors": { ar: "أقل", en: "Less" },
  "filter.colorWhite": { ar: "أبيض", en: "White" },
  "filter.colorRed": { ar: "أحمر", en: "Red" },
  "filter.colorGreen": { ar: "أخضر", en: "Green" },
  "filter.colorBlue": { ar: "أزرق", en: "Blue" },
  "filter.colorLightBlue": { ar: "أزرق فاتح", en: "Light Blue" },
  "filter.colorGray": { ar: "أسمنتي", en: "Gray" },
  "filter.colorBlack": { ar: "أسود", en: "Black" },
  "filter.colorYellow": { ar: "أصفر", en: "Yellow" },
  "filter.colorTeal": { ar: "بترولي", en: "Teal" },
  "filter.colorSilver": { ar: "فضي", en: "Silver" },
  "filter.colorGold": { ar: "ذهبي", en: "Gold" },
  "filter.colorBrown": { ar: "بني", en: "Brown" },
  "filter.colorOrange": { ar: "برتقالي", en: "Orange" },
  "filter.colorBeige": { ar: "بيج", en: "Beige" },
  "filter.colorPurple": { ar: "بنفسجي", en: "Purple" },
  "filter.interiorSpecs": { ar: "مواصفات داخلية", en: "Interior Features" },
  "filter.exteriorSpecs": { ar: "مواصفات خارجية", en: "Exterior Features" },
  "filter.showMore": { ar: "المزيد", en: "Show More" },
  "filter.showLess": { ar: "الأقل", en: "Show Less" },
  "filter.intAuxUsb": { ar: "مدخل AUX / USB", en: "AUX / USB" },
  "filter.intAirbags": { ar: "أكياس هوائية", en: "Airbags" },
  "filter.intPowerSeats": { ar: "تحكم مقاعد كهرباء", en: "Power Seats" },
  "filter.intSteeringControl": { ar: "تحكم مقود", en: "Steering Controls" },
  "filter.intSeatMemory": { ar: "ذاكرة مقاعد", en: "Seat Memory" },
  "filter.intPowerWindows": { ar: "زجاج كهربائي", en: "Power Windows" },
  "filter.intCentralLock": { ar: "سنترلوك", en: "Central Lock" },
  "filter.intHeatedSeats": { ar: "كراسي مدفأة", en: "Heated Seats" },
  "filter.intCdPlayer": { ar: "مشغل اسطوانات CD", en: "CD Player" },
  "filter.intLeatherSeats": { ar: "مقاعد جلد", en: "Leather Seats" },
  "filter.intSportSeats": { ar: "مقاعد رياضية", en: "Sport Seats" },
  "filter.intHeatedSteering": { ar: "مقود مدفأ", en: "Heated Steering" },
  "filter.intRearElectric": { ar: "مقعد خلفي كهربائي", en: "Rear Electric Seat" },
  "filter.intCooledSeats": { ar: "مقاعد مبردة", en: "Cooled Seats" },
  "filter.intAc": { ar: "مكيف", en: "A/C" },
  "filter.intAlarm": { ar: "نظام إنذار", en: "Alarm System" },
  "filter.extDaytimeLights": { ar: "أنوار نهارية", en: "Daytime Lights" },
  "filter.extSpareTire": { ar: "إطار احتياطي", en: "Spare Tire" },
  "filter.extAlloyWheels": { ar: "جنوط", en: "Alloy Wheels" },
  "filter.extFrontSensors": { ar: "حساسات أمامية", en: "Front Sensors" },
  "filter.extRearSensors": { ar: "حساسات خلفية", en: "Rear Sensors" },
  "filter.extKeylessEntry": { ar: "دخول بدون مفتاح", en: "Keyless Entry" },
  "filter.extSunroof": { ar: "فتحة", en: "Sunroof" },
  "filter.extPanorama": { ar: "فتحة بانوراما", en: "Panoramic Roof" },
  "filter.extPowerMirrors": { ar: "مرايا كهربائية", en: "Power Mirrors" },
  "filter.extFoldingMirrors": { ar: "مرايا قابلة للطي كهربائياً", en: "Power Folding Mirrors" },
  "filter.extXenonLights": { ar: "مصابيح زينون", en: "Xenon Lights" },
  "filter.extLedLights": { ar: "مصابيح ليد", en: "LED Lights" },
  "filter.extSportEdition": { ar: "نسخة رياضية", en: "Sport Edition" },
  "filter.extRearHook": { ar: "هوك خلفي", en: "Rear Hook" },
  "filter.regionalSpecs": { ar: "مواصفات إقليمية", en: "Regional Specs" },
  "filter.specAmerican": { ar: "مواصفات أمريكية", en: "American Specs" },
  "filter.specEuropean": { ar: "مواصفات أوروبية", en: "European Specs" },
  "filter.specGulf": { ar: "مواصفات خليجية", en: "Gulf Specs" },
  "filter.specChinese": { ar: "مواصفات صينية", en: "Chinese Specs" },
  "filter.specKorean": { ar: "مواصفات كوريا", en: "Korean Specs" },
  "filter.specJapanese": { ar: "مواصفات يابانية", en: "Japanese Specs" },
  "filter.specOther": { ar: "مواصفات أخرى", en: "Other Specs" },
  "filter.countryOfOrigin": { ar: "بلد المنشأ", en: "Country of Origin" },
  "filter.originGermany": { ar: "المانيا", en: "Germany" },
  "filter.originIndia": { ar: "الهند", en: "India" },
  "filter.originJapan": { ar: "اليابان", en: "Japan" },
  "filter.originUSA": { ar: "امريكا", en: "USA" },
  "filter.originIran": { ar: "ايران", en: "Iran" },
  "filter.originSpain": { ar: "اسبانيا", en: "Spain" },
  "filter.originUAE": { ar: "الإمارات", en: "UAE" },
  "filter.originSweden": { ar: "السويد", en: "Sweden" },
  "filter.originChina": { ar: "الصين", en: "China" },
  "filter.originItaly": { ar: "ايطاليا", en: "Italy" },
  "filter.originUK": { ar: "بريطانيا", en: "UK" },
  "filter.originRussia": { ar: "روسيا", en: "Russia" },
  "filter.originFrance": { ar: "فرنسا", en: "France" },
  "filter.originKorea": { ar: "كوريا", en: "Korea" },
  "filter.originMalaysia": { ar: "ماليزيا", en: "Malaysia" },
  "filter.originNetherlands": { ar: "هولندا", en: "Netherlands" },
  "filter.license": { ar: "الترخيص", en: "License" },
  "filter.licensed": { ar: "مرخصة", en: "Licensed" },
  "filter.unlicensed": { ar: "غير مرخصة", en: "Unlicensed" },
  "filter.insurance": { ar: "التأمين", en: "Insurance" },
  "filter.insuranceMandatory": { ar: "تأمين إلزامي", en: "Mandatory Insurance" },
  "filter.insuranceComprehensive": { ar: "تأمين شامل", en: "Comprehensive Insurance" },
  "filter.insuranceNone": { ar: "غير مؤمنة", en: "Uninsured" },
  "filter.customs": { ar: "الجمرك", en: "Customs" },
  "filter.customsCleared": { ar: "مجمركة", en: "Customs Cleared" },
  "filter.customsNotCleared": { ar: "غير مجمركة", en: "Not Cleared" },
  "filter.select": { ar: "اختر", en: "Select" },
