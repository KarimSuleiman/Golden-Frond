...
const translations: Translations = {
  ...
  "filter.extPanoramicRoof": { ar: "فتحة بانوراما", en: "Panoramic Roof" },
  "filter.extRearCamera": { ar: "كاميرا خلفية", en: "Rear Camera" },
  "filter.ext360Camera": { ar: "كاميرا 360°", en: "360° Camera" },
  "filter.extParkingSensors": { ar: "حساسات ركن", en: "Parking Sensors" },
  "filter.extFrontCamera": { ar: "كاميرا أمامية", en: "Front Camera" },
  "filter.extAdaptiveLights": { ar: "مصابيح تكيفية", en: "Adaptive Lights" },
  "filter.extRemoteStart": { ar: "تشغيل عن بُعد", en: "Remote Start" },
  "filter.extSpareWheel": { ar: "إطار احتياطي", en: "Spare Wheel" },
  "filter.extTowHook": { ar: "هوك جر", en: "Tow Hook" },
  "filter.extRoofRack": { ar: "حامل سقف", en: "Roof Rack" },
  "filter.extRunFlatTires": { ar: "إطارات ران فلات", en: "Run Flat Tires" },
